...
class ChurchScheduleCreateNewPopup extends StatefulWidget {
  final ContentMd? model;

  const ChurchScheduleCreateNewPopup({super.key, this.model});

  @override
  State<ChurchScheduleCreateNewPopup> createState() =>
      _ChurchScheduleCreateNewPopupState();
}

class _ChurchScheduleCreateNewPopupState
    extends State<ChurchScheduleCreateNewPopup>
    with FormsMixin<ChurchScheduleCreateNewPopup> {
