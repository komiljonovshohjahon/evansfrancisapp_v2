...
class UaeYtCreateNewPopup extends StatefulWidget {
  final YoutubeContentMd? model;
  const UaeYtCreateNewPopup({super.key, this.model});

  @override
  State<UaeYtCreateNewPopup> createState() => _UaeYtCreateNewPopupState();
}

class _UaeYtCreateNewPopupState extends State<UaeYtCreateNewPopup>
    with FormsMixin<UaeYtCreateNewPopup> {
